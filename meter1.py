...
FAN_OFF_DELAY_SEC = 150.0  # keep fan running after heat stops

# --- auto-mode fan-off timer (60s after call ends)
...
def fast_loop():
    ...
    while True:
        ...
        if follow:
   		 ...
   		 # No call → if fan is ON, schedule OFF after 150s
   		 if current_fan_on:
      		  now_t = time.time()
      		  if fan_off_at is None:
           		 fan_off_at = now_t + 150.0
